                    ...
                    <div  class="col-md-6 ">
                        ...
                        <form class="contact-form">
                                    ...
                                    <div class="form-group">
                                        <label class="bmd-label-floating">Amount of airtime you want to buy</label>
                                        <input type="number" name="amount" class="form-control" placeholder="Amount">
                                    </div>

                                    <div class="form-group">
                                        <label class="bmd-label-floating">Mpesa Phone Number</label>
                                        <input type="tel" class="form-control" name="saf" placeholder="Mpesa Phone Number">
                                    </div>
                                    <div class="form-group">
                                        <label class="bmd-label-floating">Airtel Phone Number</label>
                                        <input type="tel" class="form-control" name="airtel" placeholder="Airtel Phone Number">
                                    </div>
